...
public class SearchQueryTest {
    ...
    public void parseTest(){
        SearchQuery query = Pagination.of(SearchQuery.class, 0, 10, SortOrder.DESC, "name","age","salary");
        query.add("center")
                .isEqualTo("dasdad")
                .and("radius")
                .isEqualTo(500.0);
    ...
    @Test
    public void parseTest_2() throws IOException {
        SearchQuery query = Pagination.of(SearchQuery.class, 0, 10, SortOrder.DESC, "name","age","salary");
        ...
        System.out.println("marshal Result 1:"+ queryStr);

        //Recreate Query from string
        SearchQuery rQuery = MessageParser.unmarshal(SearchQuery.class, queryStr);
        Assert.assertTrue(Objects.equals(queryStr, rQuery.toString()));
    ...
    public void createTest() throws IOException {
        SearchQuery queryX = Pagination.of(SearchQuery.class, 0, 10, SortOrder.DESC, "name","age","salary");
    ...
    public void leadTest(){
        SearchQuery query = Pagination.of(SearchQuery.class, 0, 10, SortOrder.ASC, "CLUSTER_NAME","REGION_NAME", "AM_NAME");
    ...
    public void predicateTest(){
        ...
        try {
            ...
            ExpressionProxy[] expressions = recreate.getPredicate().resolve();
            System.out.println("");
        } catch (IOException e) {
            e.printStackTrace();
        }
